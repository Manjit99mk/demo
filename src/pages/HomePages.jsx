            ...
            <div className="main-wrapper"> {/* Uses shared class */}
                <div className="main-box"> {/* Uses shared class */}
                    ...
                    <div className="hero-section">
                        <img alt="Vivekanand College Campus"className="hero-banner-image" src="/Images/college.png" />
                        <div className="hero-overlay-text">
                            <h1>Welcome to Vivekanand College!</h1>
                            <p id="para">Your journey to excellence starts here.</p>
                            <a className="btn hero-btn" href="/addmission">Apply Now!</a>
                        </div>
                    </div>
                    ...
                    <p> Your journey to excellence starts from here</p> */}
                     ...
                     {/* Uses shared class */}
                        ...
                        <div className="campus-images-container">
                            <img src="./Images/students.jpg" alt="Vivekanand College Information" className="campus-image"/>
